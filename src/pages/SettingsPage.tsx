...
const SettingsPage: React.FC = () => {
  ...
  const handleBackupDatabase = () => {
    ...
    alert(
      "Backup database dimulai. Anda akan mendapat notifikasi setelah selesai."
    );
  };
  ...
  const handleMaintenanceMode = () => {
    ...
    alert(
      "Mode maintenance diaktifkan. Sistem akan tidak dapat diakses selama maintenance."
    );
  };
  ...
  const handleResetData = () => {
    if (
      confirm(
        "Apakah Anda yakin ingin mereset semua data testing? Tindakan ini tidak dapat dibatalkan."
      )
    ) {
    ...
    <div className="space-y-6">
      ...
      >
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Kelola konfigurasi dan parameter sistem subsidi
          </p>
        </div>
              ...
              <div className="space-y-6">
                <div>
                  <h2 className="text-xl font-semibold text-gray-800 mb-4">
                    Pengaturan Harga & Subsidi
                  </h2>
                  <p className="text-gray-600 mb-6">
                    Kelola harga dasar dan besaran subsidi untuk setiap produk
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    <h3 className="text-lg font-medium text-gray-800">Pupuk</h3>
                    <div>
                      ...
                      <input
                        type="number"
                        value={settings.pricing.pupukBasePrice}
                        onChange={(e) =>
                          updateSetting(
                            "pricing",
                            "pupukBasePrice",
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        {formatCurrency(settings.pricing.pupukBasePrice)}
                      </p>
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                        Besaran Subsidi (per kg)
                      </label>
                      <input
                        type="number"
                        value={settings.pricing.pupukSubsidy}
                        onChange={(e) =>
                          updateSetting(
                            "pricing",
                            "pupukSubsidy",
                      ...
                      />
                      <p className="text-xs text-gray-500 mt-1">
                        {formatCurrency(settings.pricing.pupukSubsidy)}
                      </p>
                    </div>
                    <div className="p-3 bg-green-50 rounded-xl">
                      <p className="text-sm text-green-700">
                        ...
                        {formatCurrency(
                          settings.pricing.pupukBasePrice -
                            settings.pricing.pupukSubsidy
                        )}
                      </p>
                    </div>
                  </div>
                  ...
                  {/* LPG Settings */}
                  <div className="space-y-4">
                    <h3 className="text-lg font-medium text-gray-800">LPG</h3>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                        Harga Dasar (per tabung)
                      </label>
                      <input
                        type="number"
                        value={settings.pricing.LPGBasePrice}
                        onChange={(e) =>
                          updateSetting(
                            "pricing",
                            "LPGBasePrice",
                      ...
                      />
                      <p className="text-xs text-gray-500 mt-1">
                        {formatCurrency(settings.pricing.LPGBasePrice)}
                      </p>
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                        Besaran Subsidi (per tabung)
                      </label>
                      <input
                        type="number"
                        value={settings.pricing.LPGSubsidy}
                        onChange={(e) =>
                          updateSetting(
                            "pricing",
                            "LPGSubsidy",
                      ...
                      />
                      <p className="text-xs text-gray-500 mt-1">
                        {formatCurrency(settings.pricing.LPGSubsidy)}
                      </p>
                    </div>
                    <div className="p-3 bg-blue-50 rounded-xl">
                      <p className="text-sm text-blue-700">
                        <strong>Harga Jual:</strong>{" "}
                        {formatCurrency(
                          settings.pricing.LPGBasePrice -
                            settings.pricing.LPGSubsidy
                        )}
                      </p>
                    </div>
                  </div>
            ...
            {activeTab === "products" && (
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-600 mb-6">
                    Aktifkan atau nonaktifkan jenis subsidi yang tersedia
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 border border-gray-200 rounded-xl">
                    ...
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        type="checkbox"
                        checked={settings.subsidyTypes.pupukActive}
                        onChange={(e) =>
                          updateSetting(
                            "subsidyTypes",
                            "pupukActive",
                  ...
                  <div className="flex items-center justify-between p-4 border border-gray-200 rounded-xl">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Program subsidi gas LPG untuk rumah tangga
                      </p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        type="checkbox"
                        checked={settings.subsidyTypes.LPGActive}
                        onChange={(e) =>
                          updateSetting(
                            "subsidyTypes",
                            "LPGActive",
            ...
            {activeTab === "quota" && (
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-600 mb-6">
                    Atur batas kuota bulanan dan maksimum penambahan kuota
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Kuota Bulanan Pupuk (kg)
                    </label>
                    <input
                      type="number"
                      value={settings.quotaLimits.pupukMonthlyLimit}
                      onChange={(e) =>
                        updateSetting(
                          "quotaLimits",
                          "pupukMonthlyLimit",
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Kuota Bulanan LPG (tabung)
                    </label>
                    <input
                      type="number"
                      value={settings.quotaLimits.LPGMonthlyLimit}
                      onChange={(e) =>
                        updateSetting(
                          "quotaLimits",
                          "LPGMonthlyLimit",
                  ...
                  <div className="md:col-span-2">
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Maksimum Penambahan Kuota (%)
                    </label>
                    <input
                      type="number"
                      value={settings.quotaLimits.maxQuotaIncrease}
                      onChange={(e) =>
                        updateSetting(
                          "quotaLimits",
                          "maxQuotaIncrease",
                    ...
                    />
                    <p className="text-xs text-gray-500 mt-1">
                      Maksimum persentase penambahan kuota dari batas normal
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-4 border border-gray-200 rounded-xl">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Notifikasi ketika stok agen rendah
                      </p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                  ...
                  <div className="flex items-center justify-between p-4 border border-gray-200 rounded-xl">
                    <div>
                      <h3 className="text-lg font-medium text-gray-800">
                        Alert Kuota Terlampaui
                      </h3>
                      <p className="text-sm text-gray-600">
                        Notifikasi ketika kuota penerima terlampaui
                      </p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <Card className="p-4">
                    ...
                    <p className="text-sm text-gray-600 mb-4">
                      Backup terakhir: 15 Januari 2024, 02:00
                    </p>
                    <Button
                      variant="secondary"
                      size="sm"
                  ...
                  <Card className="p-4">
                    ...
                    <p className="text-sm text-gray-600 mb-4">
                      Aktifkan mode maintenance untuk update sistem
                    </p>
                    <Button
                      variant="warning"
                      size="sm"
                  ...
                  <Card className="p-4">
                    ...
                    <p className="text-sm text-gray-600 mb-4">
                      Lihat dan unduh log aktivitas sistem
                    </p>
                    <Button
                      variant="secondary"
                      size="sm"
                  ...
                  <Card className="p-4">
                    ...
                    <p className="text-sm text-gray-600 mb-4">
                      Lihat aktivitas pengguna sistem
                    </p>
                    <Button
                      variant="secondary"
                      size="sm"
                  ...
                  <Card className="p-4 md:col-span-2">
                    ...
                    <p className="text-sm text-gray-600 mb-4">
                      Reset data testing (hanya untuk development)
                    </p>
                    <Button
                      variant="danger"
                      size="sm"
      ...
      >
        <div className="space-y-4">
          <div className="flex justify-between items-center">
            <p className="text-sm text-gray-600">
              Menampilkan aktivitas 24 jam terakhir
            </p>
            <Button variant="secondary" size="sm">
              <FileText className="w-4 h-4 mr-2" />
              Download Log
